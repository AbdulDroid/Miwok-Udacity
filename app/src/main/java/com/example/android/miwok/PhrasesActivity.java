...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("How re you feeling?", "michәksәs?", -1, R.raw.phrase_how_are_you_feeling));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                mMediaPlayer = MediaPlayer.create(getApplicationContext(),
                        currentWord.getmMediaResourceId());
                mMediaPlayer.start();
    ...
    protected void onStart() {
        super.onStart();
        Log.v("PhrasesActivity: ","PhrasesActivity started");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.v("PhrasesActivity: ","PhrasesActivity has paused");
        releaseMediaPlayer();
    }
    ...
    protected void onStop() {
        super.onStop();
        Log.v("PhrasesActivity: ","PhrasesActivity has stopped");
        releaseMediaPlayer();
    }
